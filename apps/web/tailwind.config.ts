  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'nebula-glow': 'radial-gradient(circle at center, rgba(0,170,255,0.15) 0%, transparent 60%)',
        'stellar-glow': 'radial-gradient(circle at center, rgba(255,165,0,0.12) 0%, transparent 60%)',
